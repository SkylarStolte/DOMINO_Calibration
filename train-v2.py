...
if dataset_name == "sneakers":
    ...
    full_dataset = CustomImageDataset(data_dir, transform=None) #data_transform)
    ...
    train_dataset = CustomImageDataset(data_dir, transform=data_transform)
    val_dataset   = CustomImageDataset(data_dir, transform=data_test_transform)
    test_dataset  = CustomImageDataset(data_dir, transform=data_test_transform)
   ...
   # Create data loaders
    train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=8)  #flipped train_set -> val_set
    valid_loader = DataLoader(val_set, batch_size=batch_size, shuffle=False, num_workers=8)   #flipped val_set -> train_set
   ...
   # Create data loaders
    ...
    test_dataset = datasets.CIFAR10(root=data_dir, train=False, download=True, transform=data_test_transform)
    ...
    test_dataset = datasets.CIFAR100(root=data_dir, train=False, download=True, transform=data_test_transform)
